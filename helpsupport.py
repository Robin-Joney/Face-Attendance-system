...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\PROJECT\Python_Test_Projects\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"D:\PROJECT\Python_Test_Projects\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"D:\PROJECT\Python_Test_Projects\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"D:\PROJECT\Python_Test_Projects\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://bit.ly/Robinjoney"
    ...
    def gmail(self):
        self.new = 1
        self.url = "https://www.Robinjoney22@gmail.com"
        webbrowser.open(self.url,new=self.new)
