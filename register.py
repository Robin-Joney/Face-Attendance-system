...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"D:\PROJECT\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        # img1=Image.open(r"D:\PROJECT\Python_Test_Projects\Images_GUI\reg1.png")
